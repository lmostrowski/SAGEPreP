...
try
    ...
    o.epoch_options.rejection_options.z=[3 3 3];
    if size(EEGBAK.data,3) > 1
        list_properties = epoch_properties(EEGBAK,setdiff(eeg_chans,chans_to_interp));
        [lengths] = min_z(list_properties,o.epoch_options.rejection_options);
    ...
    %%%%%%%%%%%%%%%%%%%%%
    if do_reref
        EEGBAK = h_pop_reref(EEGBAK, [], 'exclude',[ext_chans chans_to_interp], 'refstate', ref_chan);
    end
